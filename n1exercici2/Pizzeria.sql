...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Cients` (
  ...
  `Província` INT NOT NULL,
  `Telèfon` VARCHAR(15) NOT NULL,
  PRIMARY KEY (`idCient`),
  INDEX `Localitat_idx` (`Localitat` ASC, `Província` ASC) VISIBLE,
  CONSTRAINT `Localitat`
    FOREIGN KEY (`Localitat` , `Província`)
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Comandes` (
  ...
  ` Data/Hora comanda` DATETIME(20) NOT NULL,
  ...
  `idBotiga` INT NOT NULL,
  `Repartidor` INT NULL,
  `Data/Hora entrega` DATETIME(20) NULL,
